# Generated by Django 3.2.6 on 2022-04-03 18:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shelf_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.shelf')),
                ('file_location_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.FileLocation')),
                ('box_notes', models.CharField(blank=True, max_length=300, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='FrequencySheet',
            fields=[
                ...
                ('temporality_date', models.IntegerField(blank=True, null=True,
                 validators=[django.core.validators.MinValueValidator(1900)])),
                ('document_name_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.documentname')),
                ('person_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.publicworker')),
            ],
        ),
        migrations.CreateModel(
            name='DocumentNames',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temporality_date', models.IntegerField(blank=True, null=True,
                 validators=[django.core.validators.MinValueValidator(1900)])),
                ('dest_unity_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, related_name='unity', to='archives_app.unity')),
                ('sender_user', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.publicworker')),
                ('unity_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                 related_name='unfiled_unity', to='archives_app.unity')),
            ],
            bases=('archives_app.document',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('relation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE,
                 parent_link=True, primary_key=True, serialize=False, to='archives_app.relation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abbreviation_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.boxabbreviations')),
                ('origin_box_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.PROTECT, to='archives_app.originbox')),
            ],
            bases=('archives_app.relation',),
        ),
    ]
