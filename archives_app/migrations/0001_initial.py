# Generated by Django 3.2.6 on 2022-04-20 06:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(validators=[django.core.validators.MinValueValidator(1900)]), size=None)),
                ('month', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=3, null=True), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_location_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='archives_app.filelocation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_year', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1900)])),
                ('box_abbreviation_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='archives_app.boxabbreviations')),
                ('document_name_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='archives_app.documentname')),
                ('file_location_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='archives_app.filelocation')),
                ('rack_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='archives_app.rack')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin_boxes', models.ManyToManyField(to='archives_app.OriginBox')),
